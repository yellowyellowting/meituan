        ...
        qualities.forEach(function (quality) {
            innerHtml += `
                <a href="./detail.html?id=${quality.id}">
                    ...
                    <div class="poi-info">
                        <div class="title" title="${quality.title}">${quality.title}</div>
                        <div class="sub-title" title="${quality.subTitle}">${quality.subTitle}</div>
                        <div class="price-info">
                            <div class="current-price-wrapper">
                                <span class="price-symbol numfont">¥</span>
                                <span class="current-price numfont">${quality.currentPrice}</span>
                                <span class="old-price">${quality.oldPrice}</span>
                                <span class="sold bottom-right-info">${quality.sold}</span>
                            </div>
                        </div>
                    </div>
                </a>
